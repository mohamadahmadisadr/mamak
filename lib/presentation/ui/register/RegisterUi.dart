        ...
        child: Column(
          ...
          children: [
            ...
            mainAxisAlignment: MainAxisAlignment.end,
              children: [
                TextButton(onPressed: (){}, child: Text('حساب کاربری دارم',style: context.textTheme.caption,))
              ],
            ),
...
class StarText extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Text("*",style: context.textTheme.titleSmall?.copyWith(fontWeight: FontWeight.bold,color: Colors.red));
  }
}
